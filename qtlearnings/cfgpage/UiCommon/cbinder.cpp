...
// quint16
void
CBinder::BindEdit(CKeyDnEdit *pObj, uint16_t *pVal, uint16_t min, uint16_t max)
{
    if(pObj->pBind == NULL)
    {
...
//void
//CBinder::BindEdit(CKeyDnEdit *pObj, quint16 *pVal, quint16 *min, quint16 *max)
//{
//    if(pObj->pBind == NULL)
//    {
//        BindUint16 *pbind = new BindUint16();
...
void CBinder::BindComboBox(CKeyDnComboBox *pObj, uint16_t *pVal, const QStringList &params, const QString &strDefault)
{
    ...
    pObj->setCurrentText(strDefault);
}
////20180710合并
//void
